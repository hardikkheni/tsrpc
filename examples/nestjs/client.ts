...
import type { router } from './math.service';

const transport = new HttpClientTransport('http://localhost:3500/rpc');
...
// Fire-and-forget notification (server responds 204)
const notifResponse = await fetch('http://localhost:3500/rpc', {
  method: 'POST',
