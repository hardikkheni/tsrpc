...
Implementation status: see [docs/TODO.md](docs/TODO.md).
Planned v0.2 features (Plugin System, Typed Context, Middleware, Pub/Sub): see [docs/TODO.md](docs/TODO.md) and [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) sections 11–14.
